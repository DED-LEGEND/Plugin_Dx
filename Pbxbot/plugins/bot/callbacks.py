...
async def help_close_cb(_, cb: CallbackQuery):
    ...
    if action == "c":
        ...
        buttons = [
            [
                InlineKeyboardButton("⚜️ ᴅᴇᴘʟᴏʏ ⚜️ ", url="https://github.com/DED-LEGEND/Dxx-Plugin"),
            ...
            [
                InlineKeyboardButton("💥 sᴜᴘᴏᴏʀᴛ 💥", url="https://t.me/exam756"),
                InlineKeyboardButton("🖥️ Updates 💻", url="https://t.me/DX_INFO"),
            ],
